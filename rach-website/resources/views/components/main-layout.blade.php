    ...
    <nav class="bg-blue-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex space-x-8 overflow-x-auto">
                <a href="{{ route('home') }}" class="px-3 py-4 text-sm font-medium hover:bg-blue-700 transition duration-150 ease-in-out whitespace-nowrap {{ request()->routeIs('home') ? 'bg-blue-900' : '' }}">
                    Главная
                </a>
                <div class="relative group">
                    <button class="px-3 py-4 text-sm font-medium hover:bg-blue-700 transition duration-150 ease-in-out flex items-center whitespace-nowrap">
                        О нас
                ...
                <a href="#" class="px-3 py-4 text-sm font-medium hover:bg-blue-700 transition duration-150 ease-in-out whitespace-nowrap">
                    Отделения РАЧ
                </a>
                <a href="#" class="px-3 py-4 text-sm font-medium hover:bg-blue-700 transition duration-150 ease-in-out whitespace-nowrap">
                    Новости
